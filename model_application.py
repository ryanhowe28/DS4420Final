...
# Sidebar Navigation
page = st.sidebar.selectbox("Choose a page", ["Home Page", "Model Results"])
...
if page == "Home Page":
    ...
    This problem stems from the common “automatic image 
                classification” issue that is prevalent in many areas of the world. More specifically, 
    ...
    st.subheader("Training History for Dropout + GAP Model")
